package com.rank.sharedPreference;
...
public class SharedPreferencesManger {
    ...
    public static final String PREF_NAME = "rankkk_pref";
    public static final String LOGIN_TYPE_PREF_NAME = "rankkk_pref_token";
    public static final String REMEMBER_PREF_NAME = "rankkk_pref_remember";
